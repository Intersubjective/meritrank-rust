...
mod tests {
    use super::*;
    use meritrank::{RandomWalk, NodeId, WalkId, Weight};
    ...
    fn test_random_walk_get_nodes() {
        let random_walk = RandomWalk::from_nodes(vec![NodeId::Int(1), NodeId::Int(2), NodeId::Int(3)]);
        assert_eq!(random_walk.get_nodes(), &[NodeId::Int(1), NodeId::Int(2), NodeId::Int(3)]);
    }
    ...
    fn test_random_walk_get_nodes_mut() {
        let mut random_walk = RandomWalk::from_nodes(vec![NodeId::Int(1), NodeId::Int(2), NodeId::Int(3)]);
        random_walk._get_nodes_mut().push(NodeId::Int(4));
        assert_eq!(random_walk.get_nodes(), &[NodeId::Int(1), NodeId::Int(2), NodeId::Int(3), NodeId::Int(4)]);
    }
