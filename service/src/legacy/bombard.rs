...
fn main() {
  ...
  println!(
    "Read requests handled in {}s with {} threads: {}",
    DURATION.as_secs(),
    THREADS,
    total_r
  );
  println!(
    "Write requests handled in {}s with {} threads: {}",
    DURATION.as_secs(),
    THREADS,
    total_w
  );
  println!(
    "Throughput R: {:.2} req/s",
    total_r as f64 / DURATION.as_secs_f64()
  );
  println!(
    "Throughput W: {:.2} req/s",
    total_w as f64 / DURATION.as_secs_f64()
  );
}
