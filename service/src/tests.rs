...
fn recalculate_zero_graph_all() {
    ...
    let res: Vec<_> = graph.read_graph("", "Uadeb43da4abb", "U000000000000", false, 0, 10000);
...
fn recalculate_zero_graph_duplicates() {
    ...
    let res: Vec<_> = graph.read_graph("", "U000000000000", "Ub01f4ad1b03f", false, 0, 10000);
...
fn recalculate_zero_graph_positive_only() {
    ...
    let res: Vec<_> = graph.read_graph("", "Uadeb43da4abb", "U000000000000", true, 0, 10000);
...
fn recalculate_zero_graph_focus_beacon() {
    ...
    let res: Vec<_> = graph.read_graph("", "U95f3426b8e5d", "B79efabc4d8bf", true, 0, 10000);
...
fn scores_contexted() {
    ...
    let res: Vec<_> =
        graph.read_scores("X", "U1", "U", false, 10.0, false, 0.0, false, 0, u32::MAX);
...
fn scores_unknown_context() {
    ...
    let res: Vec<_> =
        graph.read_scores("Y", "B1", "B", false, 10.0, false, 0.0, false, 0, u32::MAX);
...
fn scores_self() {
    ...
    let res: Vec<_> =
        graph.read_scores("Y", "U1", "U", false, 10.0, false, 0.0, false, 0, u32::MAX);
