...
impl AugMultiGraph {
  ...
  fn get_ranks_or_recalculate(&mut self, context: &str, node_id: NodeId) -> Vec<(NodeId, Weight)> {
  ...
  fn get_score_or_recalculate(&mut self, context: &str, src_id: NodeId, dst_id: NodeId) -> Weight {
