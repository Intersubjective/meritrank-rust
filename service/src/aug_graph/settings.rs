...
fn _top_nodes_limit() -> usize { 100 }
fn _zero_opinion_factor() -> f64 { 0.20 }
fn _score_clusters_cache_size() -> usize { 1024 * 10 }
fn _score_clusters_timeout() -> u64 { 21600 } // 60 * 60 * 6 (6 hours)
fn _scores_cache_size() -> usize { 1024 * 10 } // 1024 * 10
fn _scores_cache_timeout() -> u64 { 3600 } // 60 * 60 (1 hour)
fn _walks_cache_size() -> usize { 1024 }
fn _filter_num_hashes() -> usize { 10 }
fn _filter_max_size() -> usize { 8192 }
fn _filter_min_size() -> usize { 32 }
fn _omit_neg_edges_scores() -> bool { false }
fn _force_read_graph_conn() -> bool { false }
fn _num_score_quantiles() -> usize { 100 }
fn _cache_capacity() -> u64 { 1_000_000 }
fn _cache_ttl() -> u64 { 3600 }
